                        ...
                        <Zoom>
                            ...
                            <div className="flex flex-col px-4 py-12 bg-white shadow-2xl rounded-3xl w-80 h-80">
                                ...
                                <p className="font-sans text-lg font-semibold text-left">
                                    ...
                                    Contribua para a manutenção da Pawkeepr assinando nosso clube de benefícios e aproveite vantagens exclusivas.
                                </p>
                            </div>
                        ...
                        <Slide left>
                            <div className="flex flex-col items-center justify-center col-span-1">
                                <img
                                    ...
                                    className="w-full md:w-10/12 pb-8 pr-16"
                                    alt="Landing Page"
                                />
                                {/*<StoreButtons/>*/}
                            </div>
                                ...
                                <div className="flex flex-wrap justify-center gap-10">
                                    ...
                                    <div className="flex flex-col items-center p-6 w-80">
                                        ...
                                        <p className="text-lg text-left text-white">
                                            ...
                                            veterinárias. Acesse informações atualizadas de qualquer hora ou lugar
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div className="grid grid-cols-1 pt-20 pl-32 mobile:pl-4 md:mt-0 lg:grid-cols-2">
                        <div className="flex flex-col col-span-1 text-left">
                            ...
                            <div className="space-y-4 mobile:pb-8">
                                ...
                                <div className="flex flex-col pr-6 pt-6">
                                    ...
                                    <p className="text-lg text-left pl-2 text-black">
                                        Facilite consultas domiciliares com acesso a prontuários eletrônicos e
                                        agendamentos diretamente no app, proporcionando um serviço de alta qualidade.
                                ...
                                <div className="flex flex-col pr-6 pt-2">
                                    ...
                                    <p className="text-lg text-left pl-2 text-black">
                                        Aumente sua visibilidade e conecte-se com mais clientes através da
                                        nossa plataforma, melhorando seu marketing e expandindo sua rede de contatos.
                                    </p>
                                </div>
                                ...
                                <div className="flex flex-col pr-6 pt-2">
                                    ...
                                    <p className="text-lg text-left pl-2 text-black">
                                        Gerencie sua clínica ou serviço domiciliar com ferramentas que ajudam
                                        na administração de agendamentos, finanças e históricos de pacientes.
                                    </p>
                                </div>
                                ...
                                <div className="flex flex-col pr-6 pt-2">
                                    ...
                                    <p className="text-lg text-left pl-2 text-black">
                                        Acesse Pawkeepr de qualquer dispositivo, seja um smartphone,
                                        tablet ou computador, mantendo sua prática móvel e eficiente.
                                    </p>
                                </div>
                                ...
                                <div className="flex flex-col pr-6 pt-2">
                                    ...
                                    <p className="text-lg text-left pl-2 text-black">
                                        Tenha total liberdade para definir os preços de seus serviços, ajustando
                                        conforme a necessidade e valorizando seu trabalho.
                                    </p>
                                </div>
